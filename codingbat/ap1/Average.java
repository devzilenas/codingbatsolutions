...
public class Average
{
	...
	/**
	 * Given an array of scores, compute the int average 
	 ...
	 * The array length will be at least 2. To practice
	 ...
	 * Write your helper method after your scoresAverage()
	 * method in the JavaBat text area. Normally you would compute
	 * averages with doubles, but here we use ints 
